...
function DesignPhilosophyCards() {
  return (
    <section className="md:w-3/5 mx-auto pt-8 bg-dbm-w-100 rounded-xl shadow-lg p-4 mb-8" id="cardpop">
      <h1 className="text-3xl md:text-5xl font-bold text-dbm-db-300 mb-4 m-auto text-left pl-4">
        My Design Philosophy
      </h1>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 justify-center w-full">
        {/* Card 1 */}
        <div className="p-4 max-w-sm mx-auto">
          <div className="flex rounded-lg bg-dbm-db-400 hover:bg-dbm-db-500 p-8 flex-col hover:scale-105 hover:text-dbm-lb-400 transition">
...
const storyFull = (
  <>
    <h1 className="text-2xl font-bold block tracking-wide text-dbm-db-400 uppercase py-4 text-left">
      My Story
    </h1>
  ...
  return (
    <section className='w-full mx-auto'>
      <div className="flex flex-wrap justify-center bg-gray-200 overflow-auto z-50 md:w-full" id="about">
        <div className="flex flex-col text-center w-4/5 md:w-full mx-auto my-8">
          {/* Main two-column layout */}
          <div className="flex flex-col md:flex-row gap-8 justify-center items-start w-full mt-8">
            {/* About Me Story (Left) */}
            <div
              className="bg-dbm-w-100 rounded-xl shadow-lg p-8 flex-1 min-w-[320px] max-w-[600px] flex flex-col justify-between h-full md:h-[420px]"
            >
              <h1 className="text-2xl font-bold block tracking-wide text-dbm-db-400 uppercase py-4 text-left">
                My Story
              </h1>
            ...
            {/* Contact & Design Philosophy (Right) */}
            <div className="flex flex-col flex-1 min-w-[320px] max-w-[600px]">
              {/* Contact Card */}
              <div
                className="bg-dbm-w-100 rounded-xl shadow-lg p-8 mb-8 flex justify-center h-full md:h-[420px]"
              >
                  <div className="flex justify-between items-center mb-4">
                      <div className="flex flex-col md:flex-row gap-6 w-full h-full">
                          <div className="flex flex-col items-center gap-4 justify-center md:border-r-2 md:pr-6 border-dbm-w-400">
                              <img
                                  src="src/assets/portraits/portrait2.png"
                              ...
                              <div className="text-xs text-slate-400 font-bold uppercase flex flex-row">
                                  ...
                                  <p className="text-dbm-db-500 flex m-auto">
